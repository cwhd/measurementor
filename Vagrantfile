...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder "[CHANGE THIS TO THE PATH WHERE YOU DOWNLOADED THIS PROJECT]", "/measurementor", create: "true" #TODO change this to where you are running measurementor
